...
class Collection extends Map {
    ...
    * @param {Object} baseObject The base class for all items
    ...
    * @param {Object} [extra] An extra parameter the constructor may need
    ...
    * @returns {Object} The first matching object, or undefined if no match
    */
    find(func) {
    ...
    * @returns {Object} The random object, or undefined if there is no match
    */
    random() {
        if(!this.size) {
            return undefined;
    ...
    * @param {function} func A function that takes an object and returns true if it matches
    * @returns {Array<Object>} An array containing all the objects that matched
    */
    filter(func) {
        const arr = [];
        for(const item of this.values()) {
