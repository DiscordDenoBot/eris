...
class CommandClient extends Client {
    ...
    * @param {Object} [options] Eris options (same as Client)
    * @param {Object} [commandOptions] Command options
    * @param {Boolean} [commandOptions.defaultHelpCommand=true] Whether to register the default help command or not
    * @param {String} [commandOptions.description="An Eris-based Discord bot"] The description to show in the default help command
    * @param {Boolean} [commandOptions.ignoreBots=true] Whether to ignore bot accounts or not
    * @param {Boolean} [commandOptions.ignoreSelf=true] Whether to ignore the bot's own account or not
    * @param {String} [commandOptions.name="<Bot username>"] The bot name to show in the default help command
    * @param {String} [commandOptions.owner="an unknown user"] The owner to show in the default help command
    * @param {String | Array<String>} [commandOptions.prefix="@mention "] The bot prefix. Can be either an array of prefixes or a single prefix. "@mention" will be automatically replaced with the bot's actual mention
    * @param {Object} [commandOptions.defaultCommandOptions={}] Default command options. This object takes the same options as a normal Command
    */
     ...
     * @param {Message} msg The message object from the message create event
     */
                ...
                try {
                    ...
                    if(resp != null) {
                        ...
                        if (msg.command.reactionButtons) {
                            for (const button of msg.command.reactionButtons) {
    ...
    * @param {String} guildID The ID of the guild to override prefixes for
    * @param {String | Array} prefix The bot prefix. Can be either an array of prefixes or a single prefix. "@mention" will be automatically replaced with the bot's actual mention
    */
    ...
    * @param {String} label The original command label
    */
