...
/**
 * @typedef {import("./PrivateChannel")} PrivateChannel
 */
...
class User extends Base {
    ...
    * @param {String} [format] The filetype of the avatar ("jpg", "png", "gif", or "webp")
    * @param {Number} [size] The size of the avatar (any power of two between 16 and 2048)
    */
