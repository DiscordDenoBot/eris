 ...
 * @typedef {import("./GuildIntegration")} GuildIntegration
 * @typedef {import("../gateway/Shard")} Shard
 */
...
class Guild extends Base {
    constructor(data, client) {
        ...
        /** @type {Number} The *exact* member count */
    ...
    * @param {String} [format] The filetype of the icon ("jpg", "png", "gif", or "webp")
    ...
    */
    ...
    /**
     * The Member object of the bot, or `undefined` if the bot isn't in this guild
     * @type {Member}
     * @readonly
     * @memberof Guild
     */
    ...
    /**
     * The Member object of the guild's owner
     * @type {Member}
     * @readonly
     * @memberof Guild
     */    
    ...
    * @param {String} [type=0] The type of the channel, either 0 or 2
